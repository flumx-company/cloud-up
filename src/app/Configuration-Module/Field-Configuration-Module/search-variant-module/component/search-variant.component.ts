...
@Component({
    ...
    styleUrls: ['./search-variant.component.scss']
})
export class SearchVariantComponent implements OnInit {
    ...
    constructor(
        ...
        private SearchVariant: SearchVariantService) {
    ...
    // addLangsFunc(e:any,type:string){
    //     e.preventDefault()
    //     type == 'add' && this.gridDataSource.push(this.addLangsData);
    //     this.addLangsData = {};
    //     this.addLangs = false;
    // }
    ...
    save(type:string){
        ...
        dataStatic.SEARCH_FIELD_CONFIGS = [];
        ...
        dataArray.forEach((data:any) => {
            let item_variant = dataStatic.SEARCH_FIELD_CONFIGS.find((item:any) => item && item.VARIANT == data.VARIANT);
            !item_variant && dataStatic.SEARCH_FIELD_CONFIGS.push({VARIANT:data.VARIANT, [data.TYPE_OBJECT]: []});
            item_variant = item_variant ?
                item_variant :
                dataStatic.SEARCH_FIELD_CONFIGS.find((item:any) => item && item.VARIANT == data.VARIANT);
            !item_variant[data.TYPE_OBJECT] && (item_variant[data.TYPE_OBJECT] = []);
            item_variant[data.TYPE_OBJECT].push(data)
